...
class Expense_category_model extends CI_Model {
	...
	var $column_order = array( 'category_name','description','status','a.store_id'); //set column field database for datatable orderable
	var $column_search = array('category_name','description','status','a.store_id'); //set column field database for datatable searchable 
