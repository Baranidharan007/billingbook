		...
		<tr>
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<?php } ?>
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="4" align="right"><?= $this->lang->line('previous_due'); ?></td>
						<td style=" padding-left: 2px; padding-right: 2px;" align="right"><?= $previous_due; ?></td>
					</tr>
					<tr>
