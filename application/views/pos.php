      ...
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <div class="box box-primary">
            ...
            <!-- Warehouse Code -->
              <?php 
              $warehouse_id=isset($warehouse_id) ? $warehouse_id : get_store_warehouse_id();
               if(warehouse_module() && warehouse_count()>1) {$this->load->view('warehouse/warehouse_code',array('show_warehouse_select_box_2'=>true,'warehouse_id'=>$warehouse_id,'div_length'=>'col-sm-3')); }else{
              ...
              <div class="box-footer bg-gray">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12 text-right">
                    ...
                    <div class="col-sm-3">
                      <button type="button" id="hold_invoice" name="" class="btn bg-maroon btn-block btn-flat btn-lg btnhold" title="Hold Invoice [Ctrl+H]" style="">
                      <i class="fa fa-hand-paper-o" aria-hidden="true"></i>
                       Hold
                    </button>
                    </div>
                    <div class="col-sm-3">
                      <button type="button" id="" name="" class="btn btn-primary btnhold btn-block btn-flat btn-lg show_payments_modal" title="Multiple Payments [Ctrl+M]" style="">
                            <i class="fa fa-credit-card" aria-hidden="true"></i>
                             Multiple
                          </button>
                    </div>
                    <div class="col-sm-3">
                      <button type="button" id="<?php echo "show_cash_modal";?>" name="" class="btn btnhold btn-success btn-block btn-flat btn-lg Ctrl_c" title="By Cash & Save [Ctrl+C]" style="">
                    ...
                    <div class="col-sm-3">
                      <button type="button" id="pay_all" name="" class="btn bg-purple btnhold btn-block btn-flat btn-lg Ctrl_a" title="By Cash & Save [Ctrl+A]" style="">
                            <i class="fa fa-money" aria-hidden="true"></i>
                             Pay All
                          </button>
                    </div>
                ...
                <div class="col-md-6">
                  <div class="input-group col-md-12">
                     ...
                     <select class="form-control select2" id="category_id" name="category_id"  style="width: 100%;"  >
                        <?php
                        $query1="select * from db_category where status=1 and store_id=".get_current_store_id();
...
function get_details(){
  ...
  $.post("<?php echo $base_url; ?>pos/get_details",{customer_id:$("#customer_id").val(),id:$("#category_id").val(),store_id:$("#store_id").val(),warehouse_id:$("#warehouse_id").val()},function(result){
    $(".search_div").html('');
...
function addrow(id){
    ...
    var service_bit   =$('#div_'+id).attr('data-service_bit');
...
function adjust_payments(){
  ...
  $(".sales_div_tot_payble").html(round_off(total-discount_amt)); 
...
<script type="text/javascript">
  shortcut.add("Ctrl+m",function(e) {
        e.preventDefault();
